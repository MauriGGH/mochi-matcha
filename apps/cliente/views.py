...
def bienvenida(request):
    ...
    # Bloquear ingreso si la mesa tiene sesiones pagadas aún no cerradas por el mesero.
    # Solo aplica cuando la mesa NO es libre; si ya está libre el mesero ya la cerró.
    if mesa.estado != "libre" and mesa.sesiones.filter(estado="pagada").exists() and not step:
        step = "mesa_cerrando"
