...
from accounts.decorators import mesero_requerido
from mesas.models import Mesa, SesionCliente
from pedidos.models import Pedido, DetallePedido, DetalleModificador, SolicitudPago
...
def confirmar_pedido_asistido(request):
    ...
    from menu.models import Producto, OpcionModificador
